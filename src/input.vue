...
$height: 32px;  $border-color: #999;  $border-color-hover: #666;  $border-radius: 4px;  $font-size: 12px;  $box-shadow-color: rgba(0, 0, 0, .5);  $red: #F14530;
.wrapper{font-size: $font-size;display: inline-flex; align-items: center;
    ...
    >input{
        ...
        &[disabled], &[readonly]{border-color: #aaa;color: #ccc;cursor: not-allowed;}
    }
}
